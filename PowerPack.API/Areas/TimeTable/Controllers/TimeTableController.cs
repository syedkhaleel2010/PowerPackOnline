...
namespace SIMS.API.Areas.TimeTable.Controllers
{
    ...
    public class TimeTableController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetTimeTableSchedule")]
        [ProducesResponseType(typeof(IEnumerable<Models.TimeTable>), (int)HttpStatusCode.OK)]
        [ProducesResponseType((int)HttpStatusCode.BadRequest)]
        public async Task<IActionResult> GetTimeTableSchedule(string username, DateTime dateTime)
        {
            var result = await _TimeTableService.GetTimeTableSchedule(username, dateTime);
            return Ok(result);
        }
    }
